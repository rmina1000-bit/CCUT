    ...
    >
      ...
      {hasImageError || !displayUrl ? (
        ...
        <img
          ...
          //   ★ 검증됨 (2026-08-01 17:50, 국장 화면 실측 — 창을 띄운 상태, 프로젝트 전환):
          //       요청 썸네일 95개 -> 39개 (-59%)
          //       전송량 8,988 kB 중 4,570 kB 만 실제 수신
          //     화면 안이 25개 근처이므로 예상 범위다.
          //     이 값은 **내 환경에서 잰 것이 아니다.** 표시되지 않은 브라우저 창에서는
          //     Chrome 이 lazy 이미지를 아예 로드하지 않아 46.6s -> 0.01s 같은 착시가 나온다
          //     (07-31 에 그 숫자를 얻고 커밋 직전 스스로 무효 판정해 되돌린 자리).
          //     lazy 관련 성능은 앞으로도 창이 보이는 환경에서만 잰다.
          loading="lazy"
          decoding="async"
